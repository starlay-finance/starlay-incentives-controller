...
import {BaseIncentivesControllerV5} from './base/BaseIncentivesControllerV5.sol';
 ...
 * @author Starlay
 **/
contract PullRewardsIncentivesControllerV5 is BaseIncentivesControllerV5 {
  ...
  constructor(IERC20 rewardToken) BaseIncentivesControllerV5(rewardToken) {}
  ...
  function initialize(
    ...
    lastAppliedTerm = IVoter(_voter).currentTermTimestamp();
  ...
  /// @inheritdoc BaseIncentivesControllerV5
  ...
  function updateLastAppliedTerm()
    external
    onlyEmissionManager
  {
      lastAppliedTerm = IVoter(_voter).currentTermTimestamp();
